	...
	<header>
		<nav class="navbar">
			<div class="contenedor">
				...
				<a href="#">Precios</a>
				<a href="#">Compañía</a>
				<a href="#" onclick="irASalir()">Salir</a>
			</div>
		</nav>
		<div class="contenedor-imagen">
			<a href="#art1">
				<img src="fondo/fond.jpg" alt="">
			</a>
		</div>
	</header>
	<main id="blog">
		<div class="contenedor">
			<aside>
				...
				<nav class="indice">
					<a href="#art1">Articulo #1</a>
					<a href="#art2">Articulo #2</a>
					<a href="#art3">Articulo #3</a>
					<a href="#art4">Articulo #4</a>
				</nav>
			</aside>
			<div class="contenido">
				<div class="post">
					<h1 class="titulo" id= "art1">Artículo #1</h1>
				...
				<div class="post">
					<h1 class="titulo" id= "art2">Artículo #2</h1>
					<p class="fecha">Publicado el 4 de Marzo de 2021</p>
					<p>
				...
				<div class="post">
					<h1 class="titulo" id= "art3">Artículo #3</h1>
					<p class="fecha">Publicado el 4 de Marzo de 2021</p>
					<p>
				...
				<div class="post">
					<h1 class="titulo"id= "art4">Artículo #4</h1>
					<p class="fecha">Publicado el 4 de Marzo de 2021</p>
					<p>
...
<script>
    ...
    window.location.href = "secion.php";
  }
</script>
